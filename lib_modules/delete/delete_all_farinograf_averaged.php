...
$delete_sql= (" DELETE FROM `farinograf_averaged`");
mysql_query($delete_sql) or die("<p>При УДАЛЕНИИ данных произошла ошибка. Операция delete_sql!</p>". mysql_error());

echo "<h1>Всі данні з таблиці farinograf_averaged успішно видалені!</h1>";


//Ожидание 1 секунды и перенаправление пользователя
header('Refresh: 1; http://factory/farinograf_averaged');
/*error_reporting(0);
