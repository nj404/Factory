...
<p align="center"><strong>Поточний прихід сировини</strong></p>
...
<td>
	<a href="lib_modules/data_move/move_coming_raw.php?id=<?php echo $item['id']?>">В архів</a>
	<a href="lib_modules/delete/delete_coming_raw.php?id=<?php echo $item['id']?>">Видалити</a>
</td>
</tr>
<?endforeach;?>
</tbody>
...
<br /><br />
		<input type="button"  class="button01" onclick="location.href='lib_modules/pdf/pdf_coming_raw.php'" value="Роздрукувати"/>