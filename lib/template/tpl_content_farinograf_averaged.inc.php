...
<input type="button" class="button01" onclick="location.href='lib_modules/excel/read_farin_averaged.php'" value="Завантажити дані">
<input type="button" class="button01" onclick="location.href='lib_modules/averaging/averaging_farinograf.php'" value="Усереднити автомат.">
<input type="button" class="button01" onclick="location.href='lib_modules/delete/delete_all_farinograf_averaged.php'" value="Очистити табл.">
